 ...
 * Terminates each complete message with a white space padded 4 character request ID, followed by an ASCII Group Separator
 * @constructor
 ...
 * @example var requestHelper = new (require(request-response))(process.stdin, process.stdout, true);
 */
 ...
 * @method pipeRequest
 * @param {module:request-response~Stream} stream - The stream to pipe and decorate with a requestId
 * @param {module:request-response~responseCallback} [callback] - A callback to use if this requestHelper receives a response with the same requestId
 */
